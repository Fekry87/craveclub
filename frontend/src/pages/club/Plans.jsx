...
import { DataTable, Modal, ModalActions, FormField, Input, TextArea, Button, PageHeader } from '../../components/CrudTable';
...
export default function Plans() {
  ...
  return (
    <div>
      ...
      {showModal && (
        <Modal title={editId ? 'Edit Plan' : 'New Plan'} onClose={() => setShowModal(false)}
