...
return [
    ...
    'release' => env('RAILWAY_GIT_COMMIT_SHA', env('SENTRY_RELEASE')),
    ...
    // The release version of your application (overridden above by RAILWAY_GIT_COMMIT_SHA)
    ...
    // Ignore common non-actionable exceptions to reduce Sentry noise
    'ignore_exceptions' => [
